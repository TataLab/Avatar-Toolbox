...
EEG_Config.numChans = 4; %minimum is 2 (apparently...setting NUMBER_OF_CHANNELS to 1 in the config.txt file on your device may cause it to incorrectly report the frame size...an undocumented limitation on the avatar hardware?)
